...
public class VillagerSpawnerStructure extends Structure<NoFeatureConfig> {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return VillagerSpawnerStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        @Override
        public void func_230364_a_(DynamicRegistries dynamicRegistryMapper, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryMapper,
                    new VillageConfig(() -> dynamicRegistryMapper.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(FrivyCatMod.ID, "villager_spawner/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Villager Spawner at " +
