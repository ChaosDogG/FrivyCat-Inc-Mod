...
public class ChaosHeadStructure extends Structure<NoFeatureConfig> {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return ChaosHeadStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryMapper, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryMapper,
                    new VillageConfig(() -> dynamicRegistryMapper.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(FrivyCatMod.ID, "chaos_head/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Creator Head at " +
