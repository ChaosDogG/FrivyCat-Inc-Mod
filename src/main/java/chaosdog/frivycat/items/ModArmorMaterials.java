...
public enum ModArmorMaterials implements IArmorMaterial {
    ...
    MUSTACHE("mustache", 5, new int[]{0, 0, 0, 0}, 25, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.fromItems(Items.STRING);
    }),
    MUMBO_MUSTACHE("mumbo_mustache", 5, new int[]{0, 0, 0, 0}, 25, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.fromItems(Items.STRING);
    });
    ...
    public String getName() {
        return FrivyCatMod.ID + ":" + this.name;
    }
