...
public class StoneBanana extends ToolItem {
    ...
    public StoneBanana(float attackDamageIn, float attackSpeedIn, IItemTier tier, Item.Properties properties) {
        super(attackDamageIn, attackSpeedIn, tier, EFFECTIVE_ON_BLOCKS, properties);
    }
