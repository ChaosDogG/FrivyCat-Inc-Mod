...
public class ScoobySkeletonModel<T extends MobEntity & IRangedAttackMob> extends BipedModel<T> {

	public ScoobySkeletonModel() {
		this(0.0f, false);
	}

	public ScoobySkeletonModel(float modelSize, boolean p_i46303_2_) {
		super(modelSize);
		if (!p_i46303_2_) {
