...
public class ModItems {
    ...
    public static final RegistryObject<Item> RED_TEA_BUCKET = ITEMS.register("red_tea_bucket", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MISC)));
    public static final RegistryObject<Item> REDSTONE_WITH_MUSTASH = ITEMS.register("redstone_with_mustash", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MISC)));
